-- 15/09/2021 14:26 -- OCORRÊNCIAS - ORION
...
CREATE TABLE ORION_OCORRENCIAS (
  ...
  NrSeqControle       BIGINT NOT NULL,
  CdSequencia         INT,
  CdOcorrencia        INT NOT NULL,
...
--- ALTER TABLE ORION_OCORRENCIAS ADD CdOcorrencia INT NOT NULL
--- ALTER TABLE ORION_OCORRENCIAS ADD DT_UPDATE DATETIME DEFAULT CURRENT_TIMESTAMP