...
const geraJsonOcorrenciaInicial = require('../../metodsDB/OR/geraJsonOcorrenciaInicial')
...
const enviaOcorrenciasIniciais = async () => {
    let retorno  = []
    let bodys    = await geraJsonOcorrenciaInicial()
    ...
    for await (let body of bodys) {
        ...
        try {
            ...
            console.log('(enviaOcorrenciasIniciais) err:', err.message )     //--- TESTES
...
module.exports = enviaOcorrenciasIniciais
